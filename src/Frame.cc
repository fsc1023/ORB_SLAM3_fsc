...
// fscd 双目 帧构造函数，K：内参，distCoef：扭曲系数，bf：双目baseline * fx
...
// fscd mCurrentFrame = Frame(mImGray, imGrayRight, timestamp, mpORBextractorLeft,
